    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(stringval)){
                    Toast.makeText(Rent.this, "Enter salary", Toast.LENGTH_SHORT).show();
                }
                else{
                    rent.add(new RentModel(Integer.parseInt(txtData.getText().toString()), monthSpinner.getSelectedItem().toString()));
                    ...
                    CustomRentAdapter adapter = new CustomRentAdapter(Rent.this, rent);
        ...
        monthSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long id) {
                ...
                Toast.makeText(Rent.this, item, Toast.LENGTH_SHORT).show();
            }
